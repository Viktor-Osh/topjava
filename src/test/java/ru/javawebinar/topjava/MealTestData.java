...
public class MealTestData {
    ...
    public static Meal getNewWithInvalidData() {
    ...
    public static Meal getInvalidDataUpdated() {
        return new Meal(MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "a", 2);
    }
}
